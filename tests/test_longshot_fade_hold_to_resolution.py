...
class TestRegistry:
    ...
    def test_registry_is_twenty_six_and_this_strategy_is_index_22(self):
        # 26 since `PM_weather_bracket_width_matched` (proposal 033),
        # `PM_fair_value_settlement_exit` (proposal 034), and
        # `PM_fair_value_mirror_fade` (D-326) were APPENDED at indices 23,
        # 24 and 25, after this strategy. This test's own name is about
        # THIS strategy's index (22), which did not move.

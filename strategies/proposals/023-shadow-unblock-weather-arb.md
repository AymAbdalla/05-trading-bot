...
thesis: "PM_weather_arb has never evaluated its own entry condition in the shadow loop: it skipped 9423 of 19154 evaluations on 'resolution_station_unknown', which is a missing input (the resolution station) rather than a false condition. Supplying that input is what turns this strategy from NOT_TESTED into testable."
...
data_requirements: "BLOCKER: the resolution station. Measured over 19154 live shadow evaluations, 96.5% of skips were data-blocked. Until that input exists this strategy is NOT_TESTED (convention 11) and must not be reported as having looked and declined."
...
| evaluations | 19154 |
| entries | 0 |
| skips classed DATA_BLOCKER | 18489 |
| skips classed GENUINE | 665 |

Dominant skip reason: `resolution_station_unknown` (9423 of 19154).

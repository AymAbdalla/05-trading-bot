...
data_requirements: "BLOCKER: a live liquidation recorder (newest row older than stale_after_sec). Measured over 13896 live shadow evaluations, 71.0% of skips were data-blocked. Until that input exists this strategy is NOT_TESTED (convention 11) and must not be reported as having looked and declined."
...
| evaluations | 13896 |
| entries | 0 |
| skips classed DATA_BLOCKER | 9872 |
| skips classed GENUINE | 4024 |

Dominant skip reason: `liquidation_feed_stale` (8538 of 13896).

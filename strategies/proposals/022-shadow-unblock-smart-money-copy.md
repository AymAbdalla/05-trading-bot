...
thesis: "PM_smart_money_copy has never evaluated its own entry condition in the shadow loop: it skipped 9423 of 19005 evaluations on 'wallet_address_unresolved', which is a missing input (a resolvable wallet address) rather than a false condition. Supplying that input is what turns this strategy from NOT_TESTED into testable."
...
data_requirements: "BLOCKER: a resolvable wallet address. Measured over 19005 live shadow evaluations, 63.1% of skips were data-blocked. Until that input exists this strategy is NOT_TESTED (convention 11) and must not be reported as having looked and declined."
...
| evaluations | 19005 |
| entries | 0 |
| skips classed DATA_BLOCKER | 11999 |
| skips classed GENUINE | 7006 |

Dominant skip reason: `wallet_address_unresolved` (9423 of 19005).
